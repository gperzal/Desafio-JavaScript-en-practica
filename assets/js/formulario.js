        ...
        function validar(name, subject, message){
            ...
            if(validaciónNombre.test(name) == false){
                document.querySelector(".errorNombre").innerHTML = 'El nombre es requerido <br>Solo puede tener letra';
                pasamos = false;
            }
            ...
            if(validaciónAsunto.test(subject) == false){
                document.querySelector(".errorAsunto").innerHTML = 'El asunto es requerido <br>Solo puede tener letra';
                pasamos = false;
            }
            ...
            if(validaciónMensaje.test(message) == false){
                document.querySelector(".errorMensaje").innerHTML = 'El mensaje es requerido <br>Solo puede tener letra';
                pasamos = false;
            }
